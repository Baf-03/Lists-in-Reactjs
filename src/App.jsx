    ...
    <>
      ...
      <section className="mx-auto text-center mt-5 ">
        <TextField
          ...
          label="Enter Todo"
          variant="outlined"
          className="w-[80%] md:w-[80%] lg:w-[40%]"
      ...
      {uiShow.map((value, index) => {
        return (
            ...
            <section key={index} className=" w-[90%]  md:w-[70%] lg:w-[40%] flex flex-col justify-center mx-auto border border-solid rounded-lg border-black p-3 mt-[2%] ">
